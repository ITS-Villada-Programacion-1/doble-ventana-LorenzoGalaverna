...
class Principal(QMainWindow):
    ...
    @Slot()
    def buscar(self):
        self.nombre = self.ui.lblNombre.text() #leo la caja de texto de la ventana
        ...
        self.resultado = os.popen("find -not -path '/.' | grep '" + self.nombre + "'").read()#busca los archivos que coincidan con el
